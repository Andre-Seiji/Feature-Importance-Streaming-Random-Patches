...
import moa.classifiers.meta.DSSFeatureImportanceStreamingRandomPatches;
import moa.core.*;
 ...
 * @version $Revision: 7 $
 */
public class DSSFISRPHoeffdingTree extends AbstractClassifier implements MultiClassClassifier,
                                                                 CapabilitiesHandler {
...
public FlagOption binarySplitsOption = new FlagOption("binarySplits", 'b',
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, DSSFISRPHoeffdingTree ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(DSSFISRPHoeffdingTree ht, StringBuilder out,
                                    int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, DSSFISRPHoeffdingTree ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, DSSFISRPHoeffdingTree ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, DSSFISRPHoeffdingTree ht) {
            ...
            // Selected Feature é forçado
                ...
                LinkedList<Integer> bestFeatures = DSSFeatureImportanceStreamingRandomPatches.getBestFeatures();
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
      if (this.getClass() == DSSFISRPHoeffdingTree.class)
