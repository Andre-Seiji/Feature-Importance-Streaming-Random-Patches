...
import moa.classifiers.trees.DSARFHoeffdingTree;
...
/**
 * DSAdaptive Random Forest
 *
 * <p>DSAdaptive Random Forest (ARF). The 3 most important aspects of this
 ...
 * @version $Revision: 1 $
 */
public class DSAdaptiveRandomForest extends AbstractClassifier implements MultiClassClassifier,
                                                                        CapabilitiesHandler {
    ...
    public ClassOption treeLearnerOption = new ClassOption("treeLearner", 'l',
            "Random Forest Tree.", DSARFHoeffdingTree.class,
            "DSARFHoeffdingTree -e 2000000 -g 50 -c 0.01");
    ...
    protected DSARFBaseLearner[] ensemble;
    ...
    public void resetLearningImpl() {
        ...
        if(numberOfJobs != DSAdaptiveRandomForest.SINGLE_THREAD && numberOfJobs != 1)
    ...
    protected void initEnsemble(Instance instance) {
        ...
        this.ensemble = new DSARFBaseLearner[ensembleSize];
...
//        BasicClassificationPerformanceEvaluator classificationEvaluator = (BasicClassificationPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
        ...
        switch(this.mFeaturesModeOption.getChosenIndex()) {
            case DSAdaptiveRandomForest.FEATURES_SQRT:
                this.subspaceSize = (int) Math.round(Math.sqrt(n)) + 1;
                break;
            case DSAdaptiveRandomForest.FEATURES_SQRT_INV:
                this.subspaceSize = n - (int) Math.round(Math.sqrt(n) + 1);
                break;
            case DSAdaptiveRandomForest.FEATURES_PERCENT:
        ...
        DSARFHoeffdingTree treeLearner = (DSARFHoeffdingTree) getPreparedClassOption(this.treeLearnerOption);
        treeLearner.resetLearning();
        
        for(int i = 0 ; i < ensembleSize ; ++i) {
            treeLearner.subspaceSizeOption.setValue(this.subspaceSize);
            this.ensemble[i] = new DSARFBaseLearner(
                i, 
                (DSARFHoeffdingTree) treeLearner.copy(),
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
        if (this.getClass() == DSAdaptiveRandomForest.class)
     ...
     */
    protected final class DSARFBaseLearner extends AbstractMOAObject {
        public int indexOriginal;
        public long createdOn;
        public long lastDriftOn;
        public long lastWarningOn;
        public DSARFHoeffdingTree classifier;
        ...
        // Bkg learner
        protected DSARFBaseLearner bkgLearner;
        // Statistics
        ...
        private void init(int indexOriginal, DSARFHoeffdingTree instantiatedClassifier, BasicClassificationPerformanceEvaluator evaluatorInstantiated,
        ...
        public DSARFBaseLearner(int indexOriginal, DSARFHoeffdingTree instantiatedClassifier, BasicClassificationPerformanceEvaluator evaluatorInstantiated,
                    long instancesSeen, boolean useBkgLearner, boolean useDriftDetector, ClassOption driftOption, ClassOption warningOption, boolean isBackgroundLearner) {
            ...
            if(this.useDriftDetector && !this.isBackgroundLearner) {
                ...
                if(this.useBkgLearner) {
                    ...
                    if(this.warningDetectionMethod.getChange()) {
                        ...
                        DSARFHoeffdingTree bkgClassifier = (DSARFHoeffdingTree) this.classifier.copy();
                        ...
                        this.bkgLearner = new DSARFBaseLearner(indexOriginal, bkgClassifier, bkgEvaluator, instancesSeen,
    ...
    protected class TrainingRunnable implements Runnable, Callable<Integer> {
        final private DSARFBaseLearner learner;
        final private Instance instance;
        final private double weight;
        final private long instancesSeen;

        public TrainingRunnable(DSARFBaseLearner learner, Instance instance,
