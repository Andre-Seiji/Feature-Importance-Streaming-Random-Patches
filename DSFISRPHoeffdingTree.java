...
import moa.classifiers.meta.DSFeatureImportanceStreamingRandomPatches;
import moa.core.*;
...
public class DSFISRPHoeffdingTree extends AbstractClassifier implements MultiClassClassifier,
                                                                 CapabilitiesHandler {
...
public FlagOption binarySplitsOption = new FlagOption("binarySplits", 'b',
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, DSFISRPHoeffdingTree ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(DSFISRPHoeffdingTree ht, StringBuilder out,
                                    int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, DSFISRPHoeffdingTree ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, DSFISRPHoeffdingTree ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, DSFISRPHoeffdingTree ht) {
            ...
            // Prioritize Feature
                ...
                LinkedList<Integer> bestFeatures = DSFeatureImportanceStreamingRandomPatches.getBestFeatures();
                ...
                for (int i = 0; i < this.attributeObservers.size(); i++) {
                    ...
                    if (obs != null) {
                        AttributeSplitSuggestion bestSuggestion = obs.getBestEvaluatedSplitSuggestion(criterion,
                                preSplitDist, i, ht.binarySplitsOption.isSet());
                        if (bestSuggestion != null) {
                            // If BestFeatures is BestSuggestion
                            if (bestFeatures != null && bestFeatures.contains(i)) {
                                bestSuggestionsfromBestFeatures.add(bestSuggestion);
                            } else {
                                bestSuggestions.add(bestSuggestion);
                            }
                        }
                ...
                if (bestSuggestionsfromBestFeatures.size() > 0) {
                    bestSuggestions.clear();
                    bestSuggestions.addAll(bestSuggestionsfromBestFeatures);
                    bestSuggestionsfromBestFeatures.clear();
                }
            }
    ...
    protected Measurement[] getModelMeasurementsImpl() {
        return new Measurement[]{
                    ...
                    new Measurement("Age of learner", measureAge())};
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
      if (this.getClass() == DSFISRPHoeffdingTree.class)
