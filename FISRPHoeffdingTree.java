...
import moa.classifiers.meta.FeatureImportanceStreamingRandomPatches;
import moa.core.*;
...
public FlagOption binarySplitsOption = new FlagOption("binarySplits", 'b',
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public double[] getClassVotes(Instance inst, FISRPHoeffdingTree ht) {
            return this.observedClassDistribution.getArrayCopy();
        }
        ...
        public void describeSubtree(FISRPHoeffdingTree ht, StringBuilder out,
                                    int indent) {
    ...
    public static abstract class LearningNode extends Node {
        ...
        public abstract void learnFromInstance(Instance inst, FISRPHoeffdingTree ht);
    }
    ...
    public static class InactiveLearningNode extends LearningNode {
        ...
        @Override
        public void learnFromInstance(Instance inst, FISRPHoeffdingTree ht) {
    ...
    public static class ActiveLearningNode extends LearningNode {
        ...
        public AttributeSplitSuggestion[] getBestSplitSuggestions(
                SplitCriterion criterion, FISRPHoeffdingTree ht) {
    ...
    public ImmutableCapabilities defineImmutableCapabilities() {
      if (this.getClass() == FISRPHoeffdingTree.class)
